...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2ec0fcfe-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/splitbutton/SplitButton.vue?vue&type=template&id=5d7f134c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"container",staticClass:"p-splitbutton p-buttonset p-component"},[_c('PVSButton',{attrs:{"type":"button","icon":_vm.icon,"label":_vm.label,"disabled":_vm.disabled,"tabindex":_vm.tabindex},on:{"click":_vm.onClick}}),_c('PVSButton',{staticClass:"p-splitbutton-menubutton",attrs:{"type":"button","icon":"pi pi-caret-down","disabled":_vm.disabled,"aria-expanded":_vm.overlayVisible,"aria-haspopup":"true","aria-owns":_vm.ariaId + '_overlay'},on:{"click":_vm.onDropdownButtonClick}}),_c('transition',{attrs:{"name":"p-input-overlay"},on:{"enter":_vm.onOverlayEnter,"leave":_vm.onOverlayLeave}},[(_vm.overlayVisible)?_c('div',{ref:"overlay",staticClass:"p-menu p-menu-dynamic p-component",attrs:{"id":"ariaId + '_overlay'"}},[_c('ul',{staticClass:"p-menu-list p-reset",attrs:{"role":"menu"}},_vm._l((_vm.model),function(item){return _c('li',{key:item.label,class:['p-menuitem', item.class],style:(item.style),attrs:{"role":"none","target":item.target}},[_c('a',{staticClass:"p-menuitem-link",attrs:{"href":item.url||'#',"role":"menuitem"},on:{"click":function($event){return _vm.itemClick($event, item)}}},[_c('span',{class:['p-menuitem-icon', item.icon]}),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(item.label))])])])}),0)]):_vm._e()])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/splitbutton/SplitButton.vue?vue&type=template&id=5d7f134c&
    ...
    bindOutsideClickListener: function bindOutsideClickListener() {
      ...
      if (!this.outsideClickListener) {
        this.outsideClickListener = function (event) {
          if (_this.overlayVisible && _this.$refs.overlay && !_this.$refs.container.contains(event.target)) {
