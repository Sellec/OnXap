...
namespace OnXap.Modules.reCAPTCHA
{
    ...
    {
        private OnXApplication _appCore;
        private readonly string _privateKey;

        public ModelValidator(OnXApplication appCore, string privateKey, ModelMetadata metadata, ControllerContext controllerContext) : base(metadata, controllerContext)
        {
            _appCore = appCore;
