...
namespace OnXap.Modules.ItemsCustomize.DB
{
    ...
    public class CustomFieldsField : Field.IField
    {
        ...
        /// <param name="outputType">Тип вывода. Если равен <see cref="Field.OutputType.Text"/>, то возвращается <see cref="string"/>. Если равен <see cref="Field.OutputType.Html"/>, то возвращается Html-код.
