...
namespace OnXap.Modules.ItemsCustomize.Scheme
{
    ...
    public class Scheme : IScheme<Field.IField>
    {
        ...
        public Scheme(DefaultScheme defaultScheme)
        {
        ...
        public Field.IField this[int idField]
        {
            get
            {
                return _fields.Contains(idField) ? Default[idField] : null;
            }
            set
            {
                if (!_fields.Contains(idField) && Default.ContainsKey(idField)) _fields.Add(idField);
            }
        }
