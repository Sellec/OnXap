...
namespace OnXap.Users
{
    ...
    /// </summary>
    public class UserPermissions : IReadOnlyDictionary<Guid, Core.Modules.Permissions>
    {
        private Dictionary<Guid, Core.Modules.Permissions> _source = null;
        ...
        /// </summary>
        public UserPermissions(Dictionary<Guid, Core.Modules.Permissions> source = null)
        {
            _source = source == null ? new Dictionary<Guid, Core.Modules.Permissions>() : new Dictionary<Guid, Core.Modules.Permissions>(source);
        }
        ...
        {
            _source = source == null ? new Dictionary<Guid, Core.Modules.Permissions>() : source.ToDictionary(x=>x.Key, x=>new Core.Modules.Permissions(x.Value));
        }
        ...
        public Core.Modules.Permissions this[Guid moduleID] => _source[moduleID];
        ...
        /// </summary>
        public IEnumerable<Core.Modules.Permissions> Values => _source.Values;
        ...
        public bool TryGetValue(Guid moduleID, out Core.Modules.Permissions value)
        {
        ...
        /// </summary>
        public IEnumerator<KeyValuePair<Guid, Core.Modules.Permissions>> GetEnumerator()
        {
