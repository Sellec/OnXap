...
namespace OnXap.Users
{
    ...
    public class UserContextManager : UserContextManagerBase
    {
        ...
        private eAuthResult CreateUserContext(int IdUser, string user, string password, out IUserContext userContext, out string resultReason)
        {
            ...
            userContext = null;
            resultReason = null;
            OnXap.Modules.Auth.ModuleConfiguration authConfig = null;
        ...
        private bool RegisterLogHistoryEvent(CoreDB.CoreContext db, int IdUser, int IdEventType, string Comment = null)
        {
            try
            {
                // todo setError(null);
