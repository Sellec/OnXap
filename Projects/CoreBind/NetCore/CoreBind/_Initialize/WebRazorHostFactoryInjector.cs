...
{
    public class WebRazorHostFactoryInjector
    {
        public static void LoadIntoHost()
        {
            try
            {
                ...
                if (fieldValue.Count > 0) fieldValue[fieldValue.ElementAt(0).Key] = () => new Razor.RazorHostFactory();
                else fieldValue.TryAdd("System.Web.Mvc.MvcWebRazorHostFactory, System.Web.Mvc, Version=3.0.0.0, Culture=neutral, PublicKeyToken=31BF3856AD364E35", () => new Razor.RazorHostFactory());
                ...
                field.SetValue(null, new Func<string, Type>(s => typeof(Razor.RazorHostFactory)));
