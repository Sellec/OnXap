...
using OnXap.Core.ModuleExtensions.CustomFields;
using OnXap.Core.ModuleExtensions.CustomFields.Field;
...
namespace System.Web.Mvc.Html
{
    public static class HtmlHelperExtension
    {
        ...
        {
            var module = (html.ViewDataContainer as OnXap.CoreBind.Razor.IModuleProvider)?.Module;
