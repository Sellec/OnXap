...
namespace OnXap.CoreBind.Razor
{
    class RazorHost : System.Web.Mvc.Razor.MvcWebPageRazorHost
    {
        ...
        public RazorHost(string virtualPath, string physicalPath) : base(virtualPath, physicalPath)
        {
            try
            {
                this.NamespaceImports.Add(typeof(OnXap.NamespaceAnchor).Namespace);
                this.NamespaceImports.Add(typeof(OnXap.NamespaceAnchor).Namespace + ".Design.Additionals");
                this.NamespaceImports.Add(typeof(OnXap.NamespaceAnchor).Namespace + ".Design.Additionals.ClassicStructures");
        ...
        private void CheckBaseClass()
        {
            ...
            base.DefaultNamespace = typeof(Plugins.NamespaceAnchor).Namespace;
        }
