...
namespace OnXap.Binding.Providers
{
    ...
    public class SessionBinder : CoreComponentBase, IComponentSingleton
    {
        ...
        public IUserContext RestoreUserContextFromRequest()
        {
            ...
            {
                var userContextResult = AppCore.Get<UserContextManager>().CreateUserContext(idUser.Value, out var userContext);
                return userContextResult == eAuthResult.Success ? userContext : null;
            }
